...
/*
    ...
    For now, we base the subscription framework on https://sahadar.github.io/pubsub/
    ..but we might get rid of it since pubsub.js and MST each add a layer of the publish-subscribe pattern.
*/
export function subscribeToChannel(gridName, componentIndex, channelIndex){
    return pubsub.subscribe(`mstGrid/${channelIndex}/state`, function(data) {
        mstGrids.getGrid(gridName).items[componentIndex].setState(data);
    });
}
